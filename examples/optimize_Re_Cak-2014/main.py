...
# optimize wrt bcc, fcc and hcp e-v data
ref_atoms = cat_data.get_ref_atoms(structures=['Re/229/0/1/*','Re/225/0/1/*','Re2/194/0/1/*'],quantities=['energy'])
ref_data = cat_data.get_ref_data()
cat_calc.set_atoms(ref_atoms)

# optimization variables
# optimize only the splines
var = [{"bond":["Re","Re"],'rep2':[False,False,False,False,True,True,True,True]},{"atom":"Re",'valenceelectrons':[True]}]
